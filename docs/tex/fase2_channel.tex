...
\label{sec:ch_results}
% ============================================================================

La Figura~\ref{fig:const_rx} muestra la constelaci\'{o}n 16-QAM a la
salida del canal AWGN con un nivel de ruido moderado. La dispersi\'{o}n
de los puntos alrededor de los centros ideales es proporcional a la
potencia de ruido inyectada, y demuestra la correcta independencia
entre los canales $I$ y $Q$.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{../figures/constellation_rx.png}
    \caption{Constelaci\'{o}n 16-QAM a la salida del canal AWGN simulado
             por el \textit{Golden Model}. El ruido gaussiano a\~{n}adido
             dispersa los s\'{\i}mbolos de forma isotr\'{o}pica alrededor
             de las posiciones ideales.}
    \label{fig:const_rx}
\end{figure}
