...
% ============================================================================
\section{Decisi\'{o}n de Dise\~{n}o: Optimizaci\'{o}n de Recursos}
...
capacidad de LUTs disponibles en la FPGA (8640 elementos). Tras aplicar
inicialmente la reducci\'{o}n a \SI{480}{p}, el dise\~{n}o a\'{u}n
superaba los recursos (13,117 elementos). Se opt\'{o} por aplicar
ambas estrategias de optimizaci\'{o}n:

\begin{enumerate}
    \item \textbf{Reducci\'{o}n de resoluci\'{o}n de video}: De \SI{720}{p}
          a VGA \SI{480}{p}, reduciendo la frecuencia serial de
          \SI{371,25}{MHz} a \SI{126}{MHz}.
    \item \textbf{Reducci\'{o}n del filtro RRC}: De 33 a 17~taps,
          manteniendo la simetr\'{\i}a y el roll-off $\alpha = 0.25$.
\end{enumerate}

\subsection{Justificaci\'{o}n del Filtro de 17 Taps}

El filtro RRC de 17~taps representa un compromiso razonable:

\begin{itemize}
    \item A\'{u}n cubre aproximadamente 4~per\'{\i}odos de s\'{\i}mbolo
          (17 taps / 4 SPS $\approx$ 4 s\'{\i}mbolos).
    \item Mantiene simetr\'{\i}a par (Tipo~I), garantizando fase lineal.
    \item El SQNR de cuantizaci\'{o}n permanece alto ($>$\SI{60}{dB}).
    \item Reduce $\sim$50\% de los multiplicadores respecto a 33~taps.
    \item Es suficiente para prop\'{o}sitos did\'{a}cticos del TFG.
\end{itemize}

Para aplicaciones de producci\'{o}n, se recomendar\'{\i}a un filtro
m\'{a}s largo o una FPGA de mayor capacidad (ej.~GW2AR con $>$18k~LUTs).
...
\begin{itemize}
    ...
    \item \textbf{Optimizaci\'{o}n de recursos}: 480p + 17~taps RRC para
          caber en los 8640~LUTs del GW1NR-9.
\end{itemize}
