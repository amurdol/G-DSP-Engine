...
% ============================================================================
\section{Decisi\'{o}n de Dise\~{n}o: Resoluci\'{o}n 480p}
\label{sec:design_tradeoff}
% ============================================================================

Durante la integraci\'{o}n, se identific\'{o} que la implementaci\'{o}n
original a \SI{720}{p} con el filtro RRC de 33~taps exced\'{\i}a la
capacidad de LUTs disponibles en la FPGA (8640). Se evaluaron dos
alternativas:

\begin{enumerate}
    \item \textbf{Reducci\'{o}n del filtro RRC}: Disminuir de 33 a 17~taps,
          sacrificando respuesta en frecuencia y rechazando menos ISI.
    \item \textbf{Reducci\'{o}n de resoluci\'{o}n de video}: Cambiar de
          \SI{720}{p} a VGA \SI{480}{p}, reduciendo la frecuencia del
          reloj serial de \SI{371,25}{MHz} a \SI{126}{MHz}.
\end{enumerate}

Se opt\'{o} por la \textbf{estrategia Quality-First} (opci\'{o}n~2),
priorizando la calidad de la se\~{n}al DSP sobre la resoluci\'{o}n
visual. Esta decisi\'{o}n se justifica por:

\begin{itemize}
    \item El objetivo principal del proyecto es demostrar el procesamiento
          de se\~{n}ales, no la calidad de imagen.
    \item El filtro RRC completo garantiza la conformidad con el criterio
          de Nyquist y minimiza ISI.
    \item La reducci\'{o}n de frecuencia serial (de \SI{371}{MHz} a
          \SI{126}{MHz}) mejora los m\'{a}rgenes de timing y reduce el
          consumo de potencia.
    \item VGA \SI{480}{p} es ampliamente compatible con monitores y
          suficiente para visualizar la constelaci\'{o}n 16-QAM.
\end{itemize}

La arquitectura final utiliza un \'{a}rea de dibujo de $256 \times 256$
p\'{\i}xeles centrada en el frame de $640 \times 480$, manteniendo
visibilidad adecuada de los 16~puntos de la constelaci\'{o}n.
...
\begin{itemize}
    ...
    \item \textbf{Tradeoff Quality-First}: se prioriz\'{o} la calidad
          DSP (33~taps RRC) sobre resoluci\'{o}n de video (720p $\to$ 480p).
\end{itemize}
